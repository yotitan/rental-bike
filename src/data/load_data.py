...
def load_data( data_path, features, cat_features ):
    """
    ...
    for cat_feature in cat_features:
        ...
        df[cat_feature] = df[cat_feature].cat.codes
...
def load_raw_data( config_path ):
    ...
    features = config['raw_data_config']['features']
    cat_features = config['raw_data_config']['cat_features']
    
    df=load_data( external_data_path, features, cat_features )
